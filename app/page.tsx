      ...
      <Section id="pricing" className="py-16">
        ...
        <div className="mt-10 grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="card hover-card">
            <div className="p-5 border-b text-lg font-semibold">위치 독점권 (5년)</div>
            <div className="p-5">
              <div className="text-3xl font-extrabold">₩500,000</div>
              <p className="mt-2 text-sm text-slate-600">원하는 GPS 좌표에 5년간 독점 AR 노출권을 확보합니다.</p>
          ...
          <div className="card hover-card">
            ...
            <div className="p-5">
              ...
              <p className="mt-2 text-sm text-slate-600">변경할 내용을 서면으로 전달하면 바로 반영합니다. 별도 제작 없이 빠르게 업데이트.</p>
          ...
          <div className="card hover-card">
            ...
            <div className="p-5">
              ...
              <p className="mt-2 text-sm text-slate-600">브랜드 가이드에 맞는 AR 배너를 기획·디자인부터 맞춤 제작합니다.</p>
          ...
          <div className="grid gap-6">
            <div className="card hover-card">
              <div className="p-5 border-b text-lg font-semibold">3D 모션 배너 제작</div>
              <div className="p-5">
                <div className="text-3xl font-extrabold">₩300,000 <span className="text-base font-medium">/ 회</span></div>
                <p className="mt-2 text-sm text-slate-600">공간을 이동·회전하는 몰입형 3D AR 배너를 제작합니다.</p>
            ...
            <div className="card hover-card">
              ...
              <div className="p-5">
                ...
                <p className="mt-2 text-sm text-slate-600">완성된 3D 소재 파일을 전달하면 기존 배너와 교체합니다.</p>

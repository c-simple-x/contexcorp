  ...
  return (
    ...
    <main className="container py-12 max-w-3xl">
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-slate-600 mt-3">
          권리 행사는 이메일(<a href="mailto:hello@contexcorp.com" className="text-blue-600 hover:underline">hello@contexcorp.com</a>)로 요청하시면 지체 없이 조치합니다.
      ...
      <section className="mb-8">
        ...
        <div className="text-sm text-slate-700 space-y-1">
          ...
          <p><span className="font-semibold">이메일:</span> <a href="mailto:hello@contexcorp.com" className="text-blue-600 hover:underline">hello@contexcorp.com</a></p>
      ...
      <div className="mt-10 pt-6 border-t text-xs text-slate-400">
        <p>CONTEX Corp. · 대표: 홍정민 · 이메일: hello@contexcorp.com</p>
